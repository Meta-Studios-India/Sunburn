...
public class SharpieAudioSyncer : AudioSyncer
{
    ...
    public override void OnUpdate() {
        ...
        lightConeMaterial.SetColor("_Color", sourceLight.color*2);
        lightConeMaterial.SetFloat("_EdgeFalloff", restEdge);
    }
   ...
   private Color RandomColor() {
    ...
    private IEnumerator ColorShift(Color targetColor) {
        ...
        while (currentColor != targetColor) {
            ...
            lampMaterial.SetColor("_EmissionColor", sourceLight.color * 2);
            lightConeMaterial.SetColor("_Color", sourceLight.color * 2);
            lightConeMaterial.SetFloat("_EdgeFalloff", edgeValue);
            yield return null;
        }
        isBeat = false;
    }
